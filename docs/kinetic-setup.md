...
## What You'll Get
After setup, you'll be able to type `/nate` in any Cowork project and get responses from Nate B. Jones — an AI advisory persona powered by Kinetic's context engine. Nate draws on a curated knowledge base, diagnostic frameworks, and a system prompt to reason like a well-briefed strategic advisor. Your converstion will inlcude this context as well as the context of your Claude Project. 
