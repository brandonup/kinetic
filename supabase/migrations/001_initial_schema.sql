...
-- ============================================================
DO $$ BEGIN CREATE TYPE relationship_status AS ENUM ('new', 'warm', 'active', 'dormant'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE meeting_status AS ENUM ('upcoming', 'completed', 'cancelled'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE meeting_type AS ENUM ('networking', 'discovery_call', 'follow_up', 'coffee_chat', 'event', 'other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE knowledge_source_type AS ENUM ('article', 'youtube_transcript', 'podcast_transcript', 'video_transcript', 'research_paper', 'personal_note', 'book_notes', 'other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE opportunity_status AS ENUM ('identified', 'exploring', 'proposal_sent', 'won', 'lost', 'on_hold'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE follow_up_type AS ENUM ('thank_you', 'check_in', 'share_resource', 'intro_request', 'proposal', 'custom'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE follow_up_status AS ENUM ('pending', 'sent', 'skipped'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE client_memory_type AS ENUM ('goal', 'preference', 'decision', 'org_dynamic', 'project_status', 'constraint', 'assumption', 'hypothesis', 'other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE practice_memory_type AS ENUM ('framework', 'positioning', 'pricing', 'lesson_learned', 'market_observation', 'methodology', 'pattern_observed', 'drift_detected', 'bias_noted', 'other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE quick_capture_source AS ENUM ('slack', 'mcp_claude', 'mcp_chatgpt', 'mcp_cursor', 'mcp_other', 'web'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE pattern_type AS ENUM ('cross_client', 'market_trend', 'behavioral', 'knowledge_gap'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE pattern_confidence AS ENUM ('emerging', 'established', 'fading'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE agent_trigger_type AS ENUM ('event', 'cron', 'on_demand'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE agent_status_enum AS ENUM ('running', 'complete', 'failed'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE INDEX IF NOT EXISTS idx_client_memory_contact_id ON client_memory(contact_id);
