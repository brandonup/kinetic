...
| ADR-003: Agents Architecture | `docs/adr-003-agents-architecture.md` | Accepted (2026-03-22) |
| ADR-004: Context Stack + Generation | `docs/adr-004-context-stack-generation.md` | Accepted (2026-03-23) |
| ADR-005: Conversation Compression | `docs/adr-005-conversation-compression.md` | Accepted (2026-03-23) |
...
| Projects + Conversations Spec | `docs/specs/kin-257-projects-conversations-spec.md` | Active |
| Agents Spec | `docs/specs/agents.md` | Active |
